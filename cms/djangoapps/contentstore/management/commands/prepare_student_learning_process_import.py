...
class Command(BaseCommand):
    ...
    OUTPUT_HEADERS = [
        ...
        'vle_2',
        'vle_3',
        # Keep raw activity columns so LMS import can populate LearnerBehavior.
        'video_1',
        'quiz_1',
        'resource_1',
        'video_2',
            ...
            rows.append(
                {
                    ...
                    'vle_2': vle_2,
                    'vle_3': vle_3,
                    'video_1': (row.get('video_1') or '').strip(),
                    'quiz_1': (row.get('quiz_1') or '').strip(),
                    'resource_1': (row.get('resource_1') or '').strip(),
                    'video_2': (row.get('video_2') or '').strip(),
                    'quiz_2': (row.get('quiz_2') or '').strip(),
                    'resource_2': (row.get('resource_2') or '').strip(),
                    'video_3': (row.get('video_3') or '').strip(),
                    'quiz_3': (row.get('quiz_3') or '').strip(),
                    'resource_3': (row.get('resource_3') or '').strip(),
