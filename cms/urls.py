...
urlpatterns = [
    ...
    path('api/v1/users/search/', contentstore_views.search_users, name='search_users'),
    path('api/chalix/user-role/', contentstore_views.get_user_role, name='get_user_role'),
    path('api/v1/professional_fields/', contentstore_views.get_professional_fields, name='get_professional_fields'),
